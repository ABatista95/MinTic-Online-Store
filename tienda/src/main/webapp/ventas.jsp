      ...
      <div class="container-fluid">
        ...
        <section class="row" id="tmAbout">
          <header class="col-12 tm-about-header">
            <h2 class="text-uppercase text-center text-white tm-about-page-title">DETALLE DE VENTAS</h2>
            <hr class="tm-about-title-hr">
          </header>
          
          <div>
            <p>Tabla de infromación</p>
          </div>
        ...
        <!-- Page footer -->
        <footer class="row">
          <p class="col-12 text-white text-center tm-copyright-text">Copyright @ 2021 App Min-Tic - TingCol. Desarrollo - <a href="#" class="tm-copyright-link">Inicio</a>
            <br/>
